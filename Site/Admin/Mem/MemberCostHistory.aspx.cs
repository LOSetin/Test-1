...
public partial class MemberCostHistory : AdminBase
{
    ...
    {
        string condition = "CostType='" + CostType.JoinGroup + "' And UserName='" + UserName + "'";
    ...
    {
        Response.Redirect("MemberCostHistory.aspx?UserName="+UserName +"&bdate=" + tbBegin.Text.Trim()+"&edate="+tbEnd.Text.Trim());
    }
